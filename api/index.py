                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "  English includes an article (The/A/An). Spanish shows masculine primary form; if a common feminine exists, include it in parentheses, e.g., el profesor (la profesora). Do NOT style nouns. "
                            "• VERBS: full sentences using He/She/It/They + is/are going to + [infinitive]; "
                            "  highlight ONLY the verb token (one <span class=\"en\">…</span> in the English cell, one <span class=\"es\">…</span> in the Spanish cell). "
                            "• ADJECTIVES: for each adjective produce two short parallel sentences (positive vs opposite); style ONLY the Spanish adjective token with <span class=\"es\">…</span>. "
                            "• ADVERBS: for each adverb produce two short parallel sentences (positive vs opposite); style ONLY the Spanish adverb token with <span class=\"es\">…</span>. "
                            "• FIB (when present): English cell colors ONLY the target English word with <span class=\"en\">…</span>; "
                            "  Spanish cell OMITS the target token and inserts the English translation in parentheses at that position (no underscores). "
                            "• Answer Key: numbered, Spanish sentences; restored vocab token is wrapped with <span class=\"es\">…</span>. "
                            "• Do NOT include any 'Vocabulary Used' section in conversation outputs. "
                            "• Grammar scope uses Peter Levels 1–5 (not CEFR). "
